...
The following new options are available for altbetd and altbet-qt:
 ...
 - _-keepassname=_ Name to construct url for KeePass entry that stores the wallet passabetase
...
The following rpc commands are available:
 ...
 - _keepass setpassabetase_: updates the passabetase in KeePassHttp to a new value. This should match the passabetase you intend to use for the wallet. Please note that the standard RPC commands _walletpassabetasechange_ and the wallet encrption from the QT GUI already send the updates to KeePassHttp, so this is only necessary for manual manipulation of the password.
...
At this point, the association is made. The next action depends on your particular situation:
 ...
 - current wallet is already encrypted: use "_keepass setpassabetase_" to store the passabetase in KeePass.

At this point, the passabetase is stored in KeePassHttp. When Unlocking the wallet, one can use _keepass_ as the passabetase to trigger retrieval of the password. This works from the RPC commands as well as the GUI.
