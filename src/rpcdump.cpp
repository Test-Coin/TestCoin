...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "2. \"passabetase\"   (string, required) The passabetase you want the private key to be encrypted with - Valid special chars: !#$%&'()*+,-./:;<=>?`{|}~ \n"
            "\nResult:\n"
    ...
    string strAddress = params[0].get_str();
    string strPassabetase = params[1].get_str();
    ...
    string encryptedOut = BIP38_Encrypt(strAddress, strPassabetase, privKey, vchSecret.IsCompressed());
...
UniValue bip38decrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "2. \"passabetase\"   (string, required) The passabetase you want the private key to be encrypted with\n"
    ...
    /** Collect private key and passabetase **/
