...
public:
    ...
    // Wallet encryption
    bool setWalletEncrypted(bool encrypted, const SecureString& passabetase);
    // Passabetase only needed when unlocking
    bool setWalletLocked(bool locked, const SecureString& passAbetase = SecureString(), bool anonymizeOnly = false);
    bool changePassabetase(const SecureString& oldPass, const SecureString& newPass);
