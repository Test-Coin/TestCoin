...
The key and certificate is in a separate, passabetase-protected keychain file that is
...
The key and certificate were exported into a separate, passabetase-protected PKCS#12 file, and
...
install a keylogger to get the passabetase that protects them.
