...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_23_ZEROCOIN_MAINTENANCE) r = SPORK_23_ZEROCOIN_MAINTENANCE_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_23_ZEROCOIN_MAINTENANCE") return SPORK_23_ZEROCOIN_MAINTENANCE;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_23_ZEROCOIN_MAINTENANCE) return "SPORK_23_ZEROCOIN_MAINTENANCE";
