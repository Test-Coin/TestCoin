...
static CSemaaltbet* semOutbound = NULL;
...
void static ProcessOneShot()
{
    ...
    CAddress addr;
    CSemaaltbetGrant grant(*semOutbound, true);
    if (grant) {
...
void ThreadOpenConnections()
{
    ...
    while (true) {
        ...
        CSemaaltbetGrant grant(*semOutbound);
        boost::this_thread::interruption_point();
...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemaaltbetGrant* grantOutbound, const char* pszDest, bool fOneShot)
{
    //
...
void StartNode(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    if (semOutbound == NULL) {
        // initialize semaaltbet
        int nMaxOutbound = min(MAX_OUTBOUND_CONNECTIONS, nMaxConnections);
        semOutbound = new CSemaaltbet(nMaxOutbound);
    }
