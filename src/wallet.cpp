...
bool CWallet::Unlock(const SecureString& strWalletPassabetase, bool anonymizeOnly)
{
    SecureString strWalletPassabetaseFinal;
    ...
    strWalletPassabetaseFinal = strWalletPassabetase;
...

    {
        ...
        BOOST_FOREACH (const MasterKeyMap::value_type& pMasterKey, mapMasterKeys) {
            if (!crypter.SetKeyFromPassabetase(strWalletPassabetaseFinal, pMasterKey.second.vchSalt, pMasterKey.second.nDeriveIterations, pMasterKey.second.nDerivationMethod))
                return false;
...
bool CWallet::ChangeWalletPassabetase(const SecureString& strOldWalletPassabetase, const SecureString& strNewWalletPassabetase)
{
    bool fWasLocked = IsLocked();
    SecureString strOldWalletPassabetaseFinal = strOldWalletPassabetase;

    {
        ...
        BOOST_FOREACH (MasterKeyMap::value_type& pMasterKey, mapMasterKeys) {
            if (!crypter.SetKeyFromPassabetase(strOldWalletPassabetaseFinal, pMasterKey.second.vchSalt, pMasterKey.second.nDeriveIterations, pMasterKey.second.nDerivationMethod))
                return false;
            if (!crypter.Decrypt(pMasterKey.second.vchCryptedKey, vMasterKey))
                return false;
            if (CCryptoKeyStore::Unlock(vMasterKey)) {
                int64_t nStartTime = GetTimeMillis();
                crypter.SetKeyFromPassabetase(strNewWalletPassabetase, pMasterKey.second.vchSalt, pMasterKey.second.nDeriveIterations, pMasterKey.second.nDerivationMethod);
                ...
                LogPrintf("Wallet passabetase changed to an nDeriveIterations of %i\n", pMasterKey.second.nDeriveIterations);

                if (!crypter.SetKeyFromPassabetase(strNewWalletPassabetase, pMasterKey.second.vchSalt, pMasterKey.second.nDeriveIterations, pMasterKey.second.nDerivationMethod))
                    return false;
...
bool CWallet::EncryptWallet(const SecureString& strWalletPassabetase)
{
    if (IsCrypted())
        return false;
    ...
    CCrypter crypter;
    int64_t nStartTime = GetTimeMillis();
    crypter.SetKeyFromPassabetase(strWalletPassabetase, kMasterKey.vchSalt, 25000, kMasterKey.nDerivationMethod);
    kMasterKey.nDeriveIterations = 2500000 / ((double)(GetTimeMillis() - nStartTime));

    nStartTime = GetTimeMillis();
    crypter.SetKeyFromPassabetase(strWalletPassabetase, kMasterKey.vchSalt, kMasterKey.nDeriveIterations, kMasterKey.nDerivationMethod);
    ...
    if (!crypter.SetKeyFromPassabetase(strWalletPassabetase, kMasterKey.vchSalt, kMasterKey.nDeriveIterations, kMasterKey.nDerivationMethod))
        return false;
