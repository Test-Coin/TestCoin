...
extern std::string HelpRequiringPassabetase();
...
extern UniValue walletpassabetase(const UniValue& params, bool fHelp);
extern UniValue walletpassabetasechange(const UniValue& params, bool fHelp);
