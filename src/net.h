...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemaaltbetGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemaaltbetGrant grantOutbound;
