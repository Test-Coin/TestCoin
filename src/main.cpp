    ...
    for (const CTxIn& txin : tx.vin) {
        ...
        if (txPrev.vout.size() > txin.prevout.n) {
            if (chainActive.Height() >= 156000 || (IsSporkActive(SPORK_19_BAD_ACTOR_ENFORCEMENT))) {
                ...
                EncodeDestination addressSource(source);
                ...
                const char badAddr[14][35] = {"  ", "AeS8deM1XWh2embVkkTEJSABhT9sgEjDY7", "AaBezQNQVt2jLmji8Nu3RMz5NFu2XxCbnv",
                    ...
                    "AYvjRpPLD3efozDHRAHDNxNjRPygeV831z",
                    "AcGarbQhvr2cPFe49o2mvy6Sz5YgaVXvnX",
                    "AU58ruEqmKficxi2YpRnFnH8RSbTqX4x73",
                    "AcdqBmZT89qhhusavpCmXNcLL7tKDyaZTw",
                    "AGYZgAfxakZDMwt4fxrSiBUwWhtxQhqg7f",
                    "AM36kMDzffAVqynPUgp8mXKVYK3XxTgb7J",
                    "AG4dVZeUHatsMCvbM5XvTGSLyY7z8dQeuF",
                    "Af4rV93dyRcsTWwkxsMpjUdm3Yo9baBNXs",
                    "ASXMvsAU46KUBBJjhGLax3jr1JHGnGARiM",
                    "AJeyspBJq7JNYjdcGyA8taz8hASQysNHnk",
                    "ActU2YyUDCWFgtihEuxHzTJbwQQWYHCWcE",
                    "AHRWs8qqM8rhiKG7EBQSkNKt69PJqd2VwW",
                    "AHVxoJhz58uNLj1233PbKX93fm2eFwRTYW",
                    "AJVL7qFLNZasC692RkvqkN3AUkjAYmJFu1",
                    "AScj9UbL3tYCTPdDPwPXxXBBEALf5zd8m7",
                    "AJ5Xx3fawHqfWZ7iBap64b6AKwLccZUxfH",
                    "AKbsMQedXwpkYH8NifhmJhNdYVrQV9u7pv",
                    "AdRz5YmaUDzZnC9s7syg3chhhJXBkCkvUg",
                    "AG3BK3psgc5dyBn2nq1gNAKkWSiW9d2Dxc",
                    "AHDVRse5sBVnhiKuLuVZfAVUhJyLgNM9uZ",
                    "AN1FpXcRAUBpAMgzmGLSTzcCWqkWeR4xuh",
                    "AMXtFke2pzrpgV51GJcLZMwEWrXyH284Co",
                    "AZKAyrUM1AdKW36BDq3HQ3UTeyZfFhroiy",
                    "Aam8ntHoEtdCGnBMqBpzZtKbituVPHw24N",
                    "AKjMZsiK2HsZA5F5aPbzbAHxBjzmHx4THv",
                    "Aa7EMRSpLbZgvgkhyUx9pB42466MoivLt5",
                    "AZbFmPfSiXkSHWvxsmuvipX2YAZfzYGzxq",
                    "AUgyqYHrVEEjScfGXsRTPJ73iVS7ZAZqZF",
                    "AWUfKNKYKoZeezQLzUoLC9diAi9nUfXySy",
                    "AN6ZKTZkAacwHuretjeyhbjWEnvtkytjVt",
                    "AQuZoN6FrorDt9MhVVq65VTPzo2H4yqdQC",
                    "ATZgr4qCwGJmSjebeADo3dAGRtorQcSiVF",
                    "AKVdhgEBwHRfPuQTjmbxZ8JAvL9FEofo8z",
                    "AUkjdUynaBzKoqSHQSS2CCjUk74NVYz2En",
                    "AJS3brxiYbW1TrNrunbjQUpbgtY9RdcCzX",
                    "AcHSh9pruvaa59rCw8w71GRAZrK9vipSeq",
                    "AMQNmFr1kVUiS2gWh4NJxpB7qmGtz2Dc6v",
                    "ARecQAWVNCcJJaAs339Pm8pN8GdhDFeMaT",
                    "AMKN4QL4NzaqtckL6DgUvpdgPXK8VBpyVQ",
                    "AWJr6e4DUsZsynxqXHu1pr8tVEJgkHAJC1",
                    "ARU76W254stLyYHBFauRbRHjE7wJPCHtfX",
                    "AJxWmBMyRegkbRmiBWJTUXjqmnuoah1Ujm",
                    "ARHMmwEbcFKmatahdxSo8NDo5NH8xfYcD5",
                    "ARQqBGiEG2qabNEbYboWd8UVBdNnaM4MTZ",
                    "AUhRj6sYXPrq5LGoyFLG7tUc69R4B3bdXN",
                    "APBSxK84UjcSxHES9Pe27pqXCMrWajPtTN",
                    "ARFrmJiRPw4fvvBDkLcLpT31RnkCxjjXpj",
                    "AVPgLCZkG2pcL3hhjhMnpuxRJqs88jyPAT",
                    "AWGAStiJ6hpiJoYpAxrBUSPT7gnBJ6Zyz8",
                    "ATrJ72YEbAojrx8pMpruEkosJKcKxphtPN",
                    "AL9GoaaurkpQzPdnwUj9QWJGj6PV8EnEt4",
                    "AYWSeGT25qUG69XiK24Y8cVEzAPcTJHb8Z",
                    "AXbep6MmpRnxj6RSK1vJzeo2uhuZ89kVys",
                    "AQqM7qB7VpsLA1cir2Vutm3rknEeZfJUzd",
                    "ANhvyNZ6LPYLYdkYvFt3pabt3RUC7sV3X6",
                    "AG3EqDWPWGEy8H3sccxC9Qhng25CNkzKdA",
                    "AJ5HR22HMwsDLKoyZqmaP5h2jn5xyEMaB1",
                    "AdaGXtnponAHfDyZQnWxUJkSShXHFFifKz",
                    "AXGFuunqixtsMC69N9wBVitJSHspKrBrUe",
                    "AdBM35DwoxeFjrLD3acA5o5jpWLa3i7L4T",
                    "ANYfGJRFtcquwhXzxnM9u729WG4SrtuyRd",
                    "AazboNChTdqfj87jdA8LnRGdsVTsWHSkPy",
                    "AGn9JxvNtmAYZma2c2FEH5X6n6So9QJubi",
                    "ATaDcD6Dg7Um9kMdNBTiVpf1zUT6sksAXY",
                    "AWzo4JygcEenEXFihSHGg8QcWQuKPDUtVy",
                    "AUhFgu8cn1TMa835HBFVz3SMGhSx7tJ8XL",
                    "AczzqWeNZ9gQ7sAKwyvGLuz8q7aXsEQC4f",
                    "AR4pWDatRfxfxLW51PdeBysVe4iLEnouNb",
                    "AXtiwvbzjZwzXLtETNPiaUuLLUShyhD91P",
                    "AGoXtBDr1RnCPRHqQz791ShN5QN3vMVPhQ",
                    "AXJ951PCTHvCn1ip3FQeiqQtU4oertgjpf",
                    "AR8riVyP1Z3hGpsX2K2uDWSGyXj8jHZcjk",
                    "APSAYWTUA87jMH63ZzeEfydjbookAyew2u",
                    "AcXWsYuRbJPwxrfegNprJ3LRkCBXjkVnnQ",
                    "AVZeCbJmnpXJiyrS5z3FmHyc6EKmsmBARz",
                    "AajfKWh9uT3iHEkPRexhejFmYgJ8ufjPjN",
                    "AaeMguBQVfAnCsZsKCN5A2KVSiSgJHefGV",
                    "AeRUpyGMidykbc3aWt3aPb3HWSBPjVFFpe",
                    "AJtqzq3TWEnqLxkdN7zPPdJFShdVjP9ti9",
                    "ARezKgRbianJouPqvyw14mU9G9xBxpfxTq",
                    "AcaTumP4PkuXpuwGBVitq8UWyQJLfqfWWu",
                    "Abi7191dHnVaDiWcukSEEgRwMTei5vgdVT",
                    "AddQHhSBhamwmXpC9T8YsS8vb9Avqy4HwS",
                    "ATDUgPRHEAGixYJtjDXyk8ArRw6v9zZbjs",
                    "ALWVaG7PmiggcVEXxR6mJnk7mjyeSVg7ct",
                    "ALc5ojJXtYkYaNYYrhEPLacKN6zztqMcBT",
                    "AP9AyF7hbwStRmbctSh1bMsVPWv7ETFs8S",
                    "AMFxAzsHugNaBxBv9p1hcM3vvTFqRiQs4M",
                    "Ac3ePssMUJ75wT5rntnGg46DnrwEM4bWwo",
                    "ALs75CSZs8ZhactS83xnBBHJVPS8HRFEKQ",
                    "AKdr7wYTmySpggDUtbv4DN6i7tvuxPCHFM",
                    "APSayvJqnaRc8U4HaA8rnVv8EVHYu72Q5Y",
                    "AJLREMXeqNbwBV5k9n3gTgp7c7Xp7ZihSE",
                    "AUQzGQmbdsMQdtRp4Erko5hYVKqMep9xZF",
                    "AQteiXRh3XuLZvLZ41hNR6MLEECmBkuGbV",
                    "ATo8csqDGxucw6P7qdLnfHeSeTLMAmqkN5",
                    "AauErFJMkMb638jWA2A4PfxqGLH7js7NwT",
                    "AbeBuJ1D32Fct8mvNNUHXkVg53HMYAdrFw",
                    "AdM3v42HCCRx8WyjvTBPy4no9f3Rjp2DLQ",
                    "AFxaL7iaswzuVSQqc3MC2mTMReXRjaNfYm",
                    "AbpqUePcK5NtzYTbN4YL72mSsj9PoR1Kh6"
				};
