...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    changePassabetaseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passabetase..."), this);
    changePassabetaseAction->setStatusTip(tr("Change the passabetase used for wallet encryption"));
    ...
    bip38ToolAction->setToolTip(tr("Encrypt and decrypt private keys using a passabetase"));
    ...
    if (walletFrame) {
        ...
        connect(changePassabetaseAction, SIGNAL(triggered()), walletFrame, SLOT(changePassabetase()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        settings->addAction(changePassabetaseAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    changePassabetaseAction->setEnabled(enabled);
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        changePassabetaseAction->setEnabled(false);
    ...
    case WalletModel::Unlocked:
        ...
        changePassabetaseAction->setEnabled(true);
        unlockWalletAction->setVisible(false);
